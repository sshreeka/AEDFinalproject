 ...
 */
public class doTestAdmittedPanel extends javax.swing.JPanel {
    ...
    UserAccount user;
    Person person;
    public doTestAdmittedPanel(JPanel userProcessContainer,EcoSystem system,Person person) {
        initComponents();
...
//         if (travelling.equals("International")){
//             person.setStatus("Quarantined");
//         }
//         if (travelling.equals("Domestic") && (person.getTestResult().equals("Positive"))){
//             
//              person.setStatus("Quarantined");
//
//         }
//         else if  (travelling.equals("Domestic") && (person.getTestResult().equals("Negative"))) {
//                           person.setStatus("Can exit Airport");
//
//         }
    ...
    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
       ...
       person.setTestResult("Positive");
        ...
        if  (travelling.equals("International") && (person.getO2()>= 95 && person.getTemp() <= 98 ) ){
         ...
         if (travelling.equals("Domestic") && (person.getO2()>= 95 && person.getTemp() <= 98 )){
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        ...
        String travelling = person.getTravelling();
                 if (travelling.equals("International")&& (person.getO2()>= 95 && person.getTemp() <= 98 )){
             person.setStatus("Discharged");
         }

         else if  (travelling.equals("Domestic") && (person.getO2()>= 95 && person.getTemp() <= 98 )) {
                           person.setStatus("Discharged");
